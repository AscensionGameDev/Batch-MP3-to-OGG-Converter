namespace Batch_MP3_to_OGG_Converter
{
    partial class frmMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Select the folder with the .mp3 files you wish to convert to .ogg";
            // 
            // label2
            // 
            ...
            this.label3.Text = "Click the button below to begin. Your mp3 files will be moved into a new folder a" +
    "nd replaced with .ogg files.";
            ...
            this.Name = "frmMain";
            this.Text = "Ascension Game Dev Batch MP3 to OGG Converter";
